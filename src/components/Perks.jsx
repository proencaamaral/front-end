...
const Perks = ({ perks, setPerks }) => {
    ...
    return (
        <div className='grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-4'>
            ...
            <label htmlFor="parking" className='flex cursor-pointer items-center rounded-xl gap-2 border border-gray-300 px-4 py-3'>
                <input
                    type="checkbox"
                    id="parking"
                    value={"parking"}
            ...
            <label htmlFor="tv" className='flex cursor-pointer items-center rounded-xl gap-2 border border-gray-300 px-4 py-3'>
                <input
                    type="checkbox"
                    id="tv"
                    value={"tv"}
            ...
            <label htmlFor="radio" className='flex cursor-pointer items-center rounded-xl gap-2 border border-gray-300 px-4 py-3'>
                <input
                    type="checkbox"
                    id="radio"
                    value={"radio"}
            ...
            <label htmlFor="pets" className='flex cursor-pointer items-center rounded-xl gap-2 border border-gray-300 px-4 py-3'>
                <input
                    type="checkbox"
                    id="pets"
                    value={"pets"}
            ...
            <label htmlFor="entrace" className='flex cursor-pointer items-center rounded-xl gap-2 border border-gray-300 px-4 py-3'>
                <input
                    type="checkbox"
                    id="entrace"
                    value={"entrace"}
